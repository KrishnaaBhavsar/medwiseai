...
export class FileService {
  ...
  async extractTextFromPDF(buffer: Buffer): Promise<string> {
    try {
      ...
      // In production, you would integrate with a proper PDF parsing library
      return "PDF text extraction is currently under development. Please upload an image of your prescription instead, or contact support for assistance with PDF files.";
    } catch (error) {
